...
def check_proxy(pip):
    try:        
        ...
        print(pip)
        req='curl -s --header "Content-Type: application/json"  --request POST  --data \'{"fullName": "\u041b\u0438\u0437\u0430 \u0414\u0435\u043c\u0438\u0434\u043e\u0432\u0430","email": "liza_demidova307459@goldmail.ru","country": "DK",  "Lang": "ru",  "countryPrefix": "",  "phone": "73966715",  "password": "abFgfarG307459",  "password repeatPassword": "abFgfarG307459",  "linkID": "",  "checkbox": "on",  "firstName": "\u041b\u0438\u0437\u0430",  "lastName": "\u0414\u0435\u043c\u0438\u0434\u043e\u0432\u0430"}\' --proxy "'+pip+'"  https://prtrend.org/wp-json/xcritical/1.0/registration'
        print(req)
